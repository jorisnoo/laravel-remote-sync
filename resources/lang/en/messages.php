...
return [
    ...
    */
    ...
    'preview' => [
        ...
        'stale_remote_tables' => ':count remote table not in local database (will remain unchanged on remote):|:count remote tables not in local database (will remain unchanged on remote):',
        'migrations_preserved' => 'Migrations table: preserved (not synced)',
        'migrations_match' => 'Migrations: in sync across environments',
        'migrations_differ' => 'Migration records differ between local and remote:',
        'migrations_differ_full' => 'Migrations table: will be overwritten (full mode)',
